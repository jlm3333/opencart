...
class __TwigTemplate_f69c00a25a9a6fd20a91e558e28f29634badd2be5c850ce4f91a704abd5a46a4 extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"col-md-9 col-md-pull-3 col-sm-12\">
        ...
        if (($context["managements"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["management"]) {
                ...
                // line 87
                if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["management"], "id", [], "any", false, false, false, 87), ($context["selected"] ?? null))) {
                    // line 88
                    echo "                      <input type=\"checkbox\" name=\"selected[]\" value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["management"], "id", [], "any", false, false, false, 88);
                    echo "\" checked=\"checked\" />
                      ";
                } else {
                    // line 90
                    echo "                      <input type=\"checkbox\" name=\"selected[]\" value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["management"], "id", [], "any", false, false, false, 90);
                    echo "\" />
                      ";
                }
                // line 91
                echo "</td>
                    <td class=\"text-left\">";
                // line 92
                echo twig_get_attribute($this->env, $this->source, $context["management"], "code", [], "any", false, false, false, 92);
                echo "</td>
                    <td class=\"text-left\">";
                // line 93
                echo twig_get_attribute($this->env, $this->source, $context["management"], "reference", [], "any", false, false, false, 93);
                echo "</td>
                    <td class=\"text-right\">";
                // line 94
                echo twig_get_attribute($this->env, $this->source, $context["management"], "error", [], "any", false, false, false, 94);
                echo "</td>
                    <td class=\"text-right\">";
                // line 95
                echo twig_get_attribute($this->env, $this->source, $context["management"], "status", [], "any", false, false, false, 95);
                echo "</td>
                    <td class=\"text-right\">";
                // line 96
                echo twig_get_attribute($this->env, $this->source, $context["management"], "section", [], "any", false, false, false, 96);
                echo "</td>
                    <td class=\"text-left\">";
                // line 97
                echo twig_get_attribute($this->env, $this->source, $context["management"], "data_log", [], "any", false, false, false, 97);
                echo "</td>
                    <td class=\"text-right\"><a href=\"";
                // line 98
                echo twig_get_attribute($this->env, $this->source, $context["management"], "edit", [], "any", false, false, false, 98);
                echo "\" data-toggle=\"tooltip\" title=\"";
...
";
    ...
    {
        return array (  386 => 150,  378 => 145,  352 => 122,  340 => 113,  336 => 112,  328 => 106,  322 => 103,  319 => 102,  316 => 101,  305 => 98,  301 => 97,  297 => 96,  293 => 95,  289 => 94,  285 => 93,  281 => 92,  278 => 91,  272 => 90,  266 => 88,  264 => 87,  261 => 86,  256 => 85,  254 => 84,  246 => 79,  242 => 78,  238 => 77,  234 => 76,  230 => 75,  226 => 74,  208 => 73,  199 => 67,  193 => 64,  182 => 56,  176 => 52,  170 => 51,  162 => 49,  154 => 47,  151 => 46,  147 => 45,  138 => 41,  134 => 40,  126 => 37,  122 => 36,  115 => 32,  109 => 28,  101 => 24,  98 => 23,  90 => 19,  88 => 18,  83 => 15,  72 => 13,  68 => 12,  63 => 10,  56 => 8,  50 => 7,  46 => 6,  37 => 1,);
    }
