...
class __TwigTemplate_2445272abbb65196daf8f047a642ee186f1d5048fb986666bbd3b2745e68f760 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["status_option"]) {
            // line 58
            echo "                  ";
            if ((($context["status"] ?? null) == twig_get_attribute($this->env, $this->source, $context["status_option"], "text", [], "any", false, false, false, 58))) {
                // line 59
                echo "                  <option value=\"";
