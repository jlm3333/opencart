...
class __TwigTemplate_b35d68c3977cf8c7e69583318bbdddcdc1ca60dd80973024e55d993fa6288276 extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"panel-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["status_option"]) {
            ...
            echo "                  <script>
                  console.log(\"";
            // line 58
            echo $context["status_option"];
            echo "\")
                  console.log(\"status_option.value\")
                  </script>
                  ";
            // line 61
            if ((($context["status"] ?? null) == twig_get_attribute($this->env, $this->source, $context["status_option"], "value", [], "any", false, false, false, 61))) {
                // line 62
                echo "                  <option value=\"";
                echo twig_get_attribute($this->env, $this->source, $context["status_option"], "value", [], "any", false, false, false, 62);
                echo "\" selected=\"selected\">";
                echo twig_get_attribute($this->env, $this->source, $context["status_option"], "text", [], "any", false, false, false, 62);
                echo "</option>
                  ";
            } else {
                // line 64
                echo "                  <option value=\"";
                echo twig_get_attribute($this->env, $this->source, $context["status_option"], "value", [], "any", false, false, false, 64);
                echo "\">";
                echo twig_get_attribute($this->env, $this->source, $context["status_option"], "text", [], "any", false, false, false, 64);
                echo "</option>
                  ";
            }
            // line 66
...
";
    ...
    {
        return array (  273 => 97,  265 => 92,  261 => 91,  247 => 82,  242 => 80,  237 => 77,  231 => 75,  229 => 74,  223 => 73,  218 => 71,  212 => 67,  206 => 66,  198 => 64,  190 => 62,  188 => 61,  182 => 58,  179 => 57,  175 => 56,  169 => 53,  160 => 49,  155 => 47,  150 => 44,  144 => 42,  142 => 41,  136 => 40,  131 => 38,  126 => 35,  120 => 33,  118 => 32,  112 => 31,  107 => 29,  102 => 27,  96 => 24,  92 => 22,  84 => 18,  82 => 17,  76 => 13,  65 => 11,  61 => 10,  56 => 8,  50 => 7,  46 => 6,  37 => 1,);
    }
