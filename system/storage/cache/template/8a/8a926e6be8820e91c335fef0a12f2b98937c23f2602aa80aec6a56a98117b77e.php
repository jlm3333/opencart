...
class __TwigTemplate_db5a5c1b49e575da162dc67627b31d3e46fa70dd3e32cf8bca3e4f297f8de4c1 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["status_option"]) {
            // line 57
            echo "                  ";
            if ((($context["status"] ?? null) == twig_get_attribute($this->env, $this->source, $context["status_option"], "value", [], "any", false, false, false, 57))) {
                // line 58
                echo "                  <option value=\"";
