...
class __TwigTemplate_835f42e01bf3ce219a7ed8c618958d3f130c163529247e448b3f8bed8145e005 extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"panel-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["status_option"]) {
            ...
            if ((($context["status"] ?? null) == twig_get_attribute($this->env, $this->source, $context["status_option"], "value", [], "any", false, false, false, 58))) {
                ...
                echo "\">";
                echo (($context["status"] ?? null) == twig_get_attribute($this->env, $this->source, $context["status_option"], "value", [], "any", false, false, false, 61));
                echo "</option>
                  ";
            }
            // line 63
